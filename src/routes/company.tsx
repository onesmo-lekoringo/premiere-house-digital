  ...
  head: () => ({
    meta: [
      { title: "The Company — Aurelia" },
      {
        name: "description",
        content:
          "Aurelia is a launch house for cinema — premieres, campaigns and press, staged with the same intention as the films themselves.",
      },
      { property: "og:title", content: "The Company — Aurelia" },
      {
        property: "og:description",
        content: "Premieres, campaigns and press — the Aurelia way.",
      },
    ],
  }),
